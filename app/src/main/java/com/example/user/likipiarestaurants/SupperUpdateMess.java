...
public class SupperUpdateMess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supper_update_mess);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        mDatabaseUsers= FirebaseDatabase.getInstance().getReference().child("Mess Supper");
    ...
    private void update() {
        ...
        Intent mainIntent = new Intent(SupperUpdateMess.this, PostActivityMess.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(mainIntent);
        Toast.makeText(SupperUpdateMess.this,"your Menu has been updated",Toast.LENGTH_LONG).show();
