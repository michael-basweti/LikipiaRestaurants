...
public class BreakfastUpdateMess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breakfast_update_mess);
    ...
    private void update() {
        ...
        Intent mainIntent = new Intent(BreakfastUpdateMess.this, PostActivityMess.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(mainIntent);
        Toast.makeText(BreakfastUpdateMess.this,"your Menu has been updated",Toast.LENGTH_LONG).show();
