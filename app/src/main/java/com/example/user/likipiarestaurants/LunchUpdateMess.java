...
public class LunchUpdateMess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_update_mess);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        mDatabaseUsers= FirebaseDatabase.getInstance().getReference().child("MESS Lunch");
    ...
    private void update() {
        ...
        Intent mainIntent = new Intent(LunchUpdateMess.this, PostActivityMess.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(mainIntent);
        Toast.makeText(LunchUpdateMess.this,"your Menu has been updated",Toast.LENGTH_LONG).show();
