...
public class LunchUpdateUBC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_update_ubc);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        mDatabaseUsers= FirebaseDatabase.getInstance().getReference().child("UBC Lunch");
    ...
    private void update() {
        ...
        Intent mainIntent = new Intent(LunchUpdateUBC.this, PostActivity.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(mainIntent);
        Toast.makeText(LunchUpdateUBC.this,"your Menu has been updated",Toast.LENGTH_LONG).show();
