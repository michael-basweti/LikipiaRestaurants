...
public class BreakfastUBC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breakfast_ubc);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<BreakfastUBCShow, BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<BreakfastUBCShow, BlogViewHolder>(
                BreakfastUBCShow.class,
                R.layout.menu_row_ubcbreakfast,
                BlogViewHolder.class,
                mDatabaseUsers

        ) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, BreakfastUBCShow model, int position) {
