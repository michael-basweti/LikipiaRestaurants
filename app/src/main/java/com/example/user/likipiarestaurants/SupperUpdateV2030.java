...
public class SupperUpdateV2030 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supper_update_v2030);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        mDatabaseUsers= FirebaseDatabase.getInstance().getReference().child("Vision Supper");
    ...
    private void update() {
        ...
        Intent mainIntent = new Intent(SupperUpdateV2030.this, PostActivityVision.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(mainIntent);
        Toast.makeText(SupperUpdateV2030.this,"your Menu has been updated",Toast.LENGTH_LONG).show();
