...
public class SupperUpdateUBC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supper_update_ubc);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        mDatabaseUsers= FirebaseDatabase.getInstance().getReference().child("UBC Supper");
    ...
    private void update() {
        ...
        Intent mainIntent = new Intent(SupperUpdateUBC.this, PostActivityMess.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(mainIntent);
        Toast.makeText(SupperUpdateUBC.this,"your Menu has been updated",Toast.LENGTH_LONG).show();
