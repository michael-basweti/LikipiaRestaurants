...
public class LunchUpdateV2030 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_update_v2030);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        mDatabaseUsers= FirebaseDatabase.getInstance().getReference().child("VISION Lunch");
    ...
    private void update() {
      ...
      final String me8 = m8.getText().toString().trim();
        ...
        Intent mainIntent = new Intent(LunchUpdateV2030.this, PostActivityVision.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(mainIntent);
        Toast.makeText(LunchUpdateV2030.this,"your Menu has been updated",Toast.LENGTH_LONG).show();
