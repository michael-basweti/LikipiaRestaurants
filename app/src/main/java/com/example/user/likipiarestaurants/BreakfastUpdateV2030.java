...
public class BreakfastUpdateV2030 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breakfast_update_v2030);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);


        mDatabaseUsers= FirebaseDatabase.getInstance().getReference().child("VISION Breakfast");
    ...
    private void update() {
        ...
        Intent mainIntent = new Intent(BreakfastUpdateV2030.this, PostActivityVision.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(mainIntent);
        Toast.makeText(BreakfastUpdateV2030.this,"your Menu has been updated",Toast.LENGTH_LONG).show();
